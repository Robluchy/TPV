...
echo ("<section class='grid grid-cols-none  xl:grid-cols-2 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-2'>"); 
    ...
    echo ("<div class='order-1 sm:order-2 pt-36 w-full justify-self-center'>");
        ...
        echo(' <div class="pl-16 xl:pl-48 lg:pl-28 md:pl-12 sm:pl-6 mt-8 inline-flex rounded-md shadow-sm">
            <a href="editp.php?id='.$detalle.'" aria-current="page" class="py-2 px-4 text-sm font-medium text-blue-700 bg-white rounded-l-lg border border-gray-200 hover:bg-gray-100 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-blue-500 dark:focus:text-white">
                Edit
            </a>
