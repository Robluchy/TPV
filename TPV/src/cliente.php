        ...
        while($rows = mysqli_fetch_array($resultado2)){	
            ...
            echo '<div id="accordion-open" data-accordion="open" class=" p-5">
                ...
                <h2 id="accordion-open-heading-1">
                    <button type="button" class="flex items-center justify-between p-5  font-medium border border-gray-700 border-b-0 text-left text-gray-500 dark:text-gray-400 bg-gray-800" data-accordion-target="#accordion-open-body-1" aria-expanded="false" aria-controls="accordion-open-body-1">
                ...
                <a href="modifycli.php?id='.$detalle.'" class="rounded-l-lg py-2 px-4 text-sm bg-neutral-50 border-slate-900 transition-all ease-in duration-75 hover:-translate-y-1 hover:scale-110 font-medium border">
                    Modify
                </a>
