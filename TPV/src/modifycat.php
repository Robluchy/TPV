<?php
    ...
    <div class="grid">
        <form method="POST" class="bg-transparent w-2/4 mt-4 justify-self-center  ">
            ...
            <input type="text" name="nombre" required minlength="1" value="'.$rows["nombre_categoria"].'" id="small-input" class="block p-2 w-full text-white bg-gray-50 rounded-lg border border-gray-300 sm:text-xs dark:bg-gray-900 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" >
