...
echo ('<div class="grid">
<form class="bg-transparent w-2/4 mt-4 justify-self-center mb-20">
    ...
    <textarea id="message" rows="4" class="block p-2.5 w-full text-sm text-white bg-gray-50 rounded-lg border border-gray-300  dark:bg-gray-900 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white " placeholder="Leave a comment..."></textarea>
